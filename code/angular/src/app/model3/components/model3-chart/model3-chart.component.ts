...
@Component({
  selector: 'app-model3-chart',
  standalone: true,
  imports: [],
  templateUrl: './model3-chart.component.html',
  styleUrl: './model3-chart.component.scss'
})
export class Model3ChartComponent implements OnChanges {
