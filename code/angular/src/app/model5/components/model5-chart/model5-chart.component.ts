...
@Component({
  selector: 'app-model5-chart',
  standalone: true,
  imports: [],
  templateUrl: './model5-chart.component.html',
  styleUrl: './model5-chart.component.scss'
})
export class Model5ChartComponent implements OnChanges {
