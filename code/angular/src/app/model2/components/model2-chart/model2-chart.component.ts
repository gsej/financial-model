...
@Component({
  selector: 'app-model2-chart',
  standalone: true,
  imports: [],
  templateUrl: './model2-chart.component.html',
  styleUrl: './model2-chart.component.scss'
})
export class Model2ChartComponent implements OnChanges {
